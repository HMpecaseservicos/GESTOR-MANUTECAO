...
def filtro_empresa(query):
    ...
    NOTA: Usa int() cast para prevenir SQL injection.
    Preferir queries parametrizadas (%s) sempre que possível.
    """
    empresa_id = int(get_empresa_id())  # Cast seguro - previne SQL injection
